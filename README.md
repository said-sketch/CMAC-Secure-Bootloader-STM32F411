...
CMAC_boot/
├── Application/          # Application firmware to be flashed on the MCU
├── Bootloader/           # Bootloader for updating firmware and verifying integrity/authenticity
├── STM32_Cryptographic/  # AES-CMAC libraries (legacy + CMOX)
├── Tool/                 # Python scripts to add CMAC tag to firmware
├── Output/               # Generated .bin files with CMAC tag
